...
class AiCOCOBaseGradioStrategy(BaseStrategy):
    @abc.abstractmethod
...
class AiCOCOSegmentationGradioStrategy(AiCOCOBaseGradioStrategy):
...
class AiCOCODetectionGradioStrategy(AiCOCOBaseGradioStrategy):
    async def apply(self, result: Dict[str, Any]) -> Tuple[List[Any], List[Any], None, str]:
